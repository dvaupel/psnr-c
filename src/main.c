...
int main(int argc, char* argv[]) {
    ...
    unsigned char* original = stbi_load(argv[1], &width_orig, &height_orig, &nrChannels_orig, 3);
    
    int width_deriv, height_deriv, nrChannels_deriv;
    unsigned char* derivative = stbi_load(argv[2], &width_deriv, &height_deriv, &nrChannels_deriv, 3);
